            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select id="FlagCssClass" name="FlagCssClass">
                        ...
                        <option 
                            <?php 
                                if(isset($dbsNews['BdsNews']['USER_ID'])){
                                    if($dbsNews['BdsNews']['USER_ID'] == $customer['TCustomer']['USER_ID']){
                ...
                <div class="controls">
                    <select class="select-box" id="AdsTypeCssClass" name="AdsTypeCssClass">
                        ...
                        ?>
                            <option 
                                <?php 
                                    if(isset($dbsNews['BdsNews']['TYPE_NEWS_CODE'])){
                                        if($dbsNews['BdsNews']['TYPE_NEWS_CODE'] == $day['DayList']['DAY_LIST_CODE']){
                                            echo 'selected="selected"';
                                        }
                                    }
                                ?>
                    ...
                    <select id="AddAdsExpirationDate" name="AddAdsExpirationDate">
                        ...
                        ?>
                            <option 
                                <?php 
                                    if(isset($dbsNews['BdsNews']['DAY_LIST_CODE'])){
                                        if($dbsNews['BdsNews']['DAY_LIST_CODE'] == $day['DayList']['DAY_LIST_CODE']){
                                            echo 'selected="selected"';
                                        }
                                    }
                                ?>
                    ...
                    <select class="select-box" id="TypeCssClass" name="TypeCssClass"><option value="">-- Vui lòng chọn --</option>
                        ...
                        <select id="AdsTypeVIPId" name="AdsTypeVIPId">
                            ...
                            ?>
                                <option 
                                    <?php 
                                        if(isset($dbsNews['BdsNews']['TIN_VIP_CODE'])){
                                            if($dbsNews['BdsNews']['TIN_VIP_CODE'] == $tinVip['TinVip']['TIN_VIP_CODE']){
                                                echo 'selected="selected"';
                                            }
                                        }
                                    ?>
                        ...
                        <select id="AddAdsVIPExpirationDate" name="AddAdsVIPExpirationDate">
                            ...
                            ?>
                                <option 
                                    <?php 
                                        if(isset($dbsNews['BdsNews']['TIN_VIP_DAY_LIST_CODE'])){
                                            if($dbsNews['BdsNews']['TIN_VIP_DAY_LIST_CODE'] == $day['DayList']['DAY_LIST_CODE']){
                                                echo 'selected="selected"';
                                            }
                                        }
                                    ?>
